...
@Component({
    templateUrl: './assetMapSettings.html',
  })
  
export class AssetMapSettingsDialog implements OnInit{
  ...
  constructor(public dialogRef: MatDialogRef<AssetMapSettingsDialog>, 
  ...
  getAllUsers(){
    ...
    this.assetMapUserLvl = userProfile.user.assetMapLvl
  ...
  updateAssetMapLvl(user: Object, newUserLvl: String){
    this.userService.updateAssetMapLvl(user, newUserLvl).subscribe(
      result =>{
        this.editingLvl = false;
        this.getAllUsers();
      }
    )
  }

  openLvlEditor(user: Object){
    this.editedUser = user;
    this.editingLvl = true;
  }
